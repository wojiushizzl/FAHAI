            ...
            ft.Card(
                ft.Container(
                    ft.Column([
                        ...
                        ft.Row(
                            [ft.Text('new train', width=80), self.train_settings_train_name, ft.Text('', width=10)], ),
                        ft.Row([ft.Text('', width=10), self.train_settings_exist_ok, self.train_settings_single_cls,
                                ft.Text('', width=10)]),
                        ...
                        ft.Row(
                            [ft.Text('batch size', width=80), self.train_settings_batch_size, ft.Text('', width=10)]),
                        ft.Row(
            ...
            content=ft.Container(
                content=ft.Column(
                    [
                        ...
                        ft.Row(
                            [
                                ft.TextButton('Folder', icon=ft.icons.FOLDER, data=text,
                                              on_click=self.open_project_folder),
